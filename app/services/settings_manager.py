...
DEFAULT_SETTINGS = {
    ...
    "advanced": {
        "health_check_timeout": 0,         # 0 = use Config.HEALTH_CHECK_TIMEOUT
        "paperless_upload_timeout": 0,
        "paperless_retry_attempts": 0,
        "paperless_retry_backoff": 0,
        "paperless_poll_interval": 0,
        "paperless_poll_timeout": 0,
        "ragflow_max_retries": 0,
        "ragflow_parse_timeout": 0,
        "ragflow_poll_interval": 0,
        "ragflow_session_timeout": 0,
        "anythingllm_max_retries": 0,
        "db_pool_min_size": 0,
        "db_pool_max_size": 0,
        "db_pool_timeout": 0,
        "flaresolverr_cache_ttl": 0,
        "flaresolverr_cache_max_size": 0,
    ...
    "properties": {
        ...
        "services": {
            ...
            "properties": {
                ...
                "paperless_timeout": {"type": "integer", "minimum": 0, "maximum": 600},
                "ragflow_url": {"type": "string"},
                "ragflow_timeout": {"type": "integer", "minimum": 0, "maximum": 600},
                "anythingllm_url": {"type": "string"},
                "anythingllm_timeout": {"type": "integer", "minimum": 0, "maximum": 600},
        ...
        "advanced": {
            "type": "object",
            "properties": {
                "health_check_timeout": {"type": "integer", "minimum": 0},
                "paperless_upload_timeout": {"type": "integer", "minimum": 0},
                "paperless_retry_attempts": {"type": "integer", "minimum": 0},
                "paperless_retry_backoff": {"type": "number", "minimum": 0},
                "paperless_poll_interval": {"type": "number", "minimum": 0},
                "paperless_poll_timeout": {"type": "integer", "minimum": 0},
                "ragflow_max_retries": {"type": "integer", "minimum": 0},
                "ragflow_parse_timeout": {"type": "integer", "minimum": 0},
                "ragflow_poll_interval": {"type": "number", "minimum": 0},
                "ragflow_session_timeout": {"type": "integer", "minimum": 0},
                "anythingllm_max_retries": {"type": "integer", "minimum": 0},
                "db_pool_min_size": {"type": "integer", "minimum": 0},
                "db_pool_max_size": {"type": "integer", "minimum": 0},
                "db_pool_timeout": {"type": "number", "minimum": 0},
                "flaresolverr_cache_ttl": {"type": "integer", "minimum": 0},
                "flaresolverr_cache_max_size": {"type": "integer", "minimum": 0},
                "search_max_results": {"type": "integer", "minimum": 0},
                "search_default_limit": {"type": "integer", "minimum": 0},
                "embedding_batch_size": {"type": "integer", "minimum": 0},
                "retry_backoff_factor": {"type": "number", "minimum": 0},
                "retry_jitter": {"type": "number", "minimum": 0},
            },
            "additionalProperties": False,
        },
    },
